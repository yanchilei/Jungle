...
Revision ID: 4ce90f21b0cb
Revises: None
Create Date: 2016-12-30 20:24:04.631158

"""

# revision identifiers, used by Alembic.
revision = '4ce90f21b0cb'
down_revision = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['watch_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('fans_id', 'watch_id')
    )
